...
//    /*     */
//    using BluetoothProfile = android.bluetooth.BluetoothProfile;
//    /*     */
//    /*     */
...
//        {
//            conditionA = this.@lock.newCondition();
//            condSetDev = this.lockSetDev.newCondition();
//        }
...
//        public virtual bool? ConnectMasterDevice
//        {
//            get
//            {
//                /*  49 */
...
//                            /*     */
//                        } /*  85 */
//                        (new ImplementPulseHandler.MyMessageThread(outerInstance, outerInstance, null)).Start();
//                        /*     */
//                        /*  87 */
...
//        private class MyMessageThread : System.Threading.Thread
//        {
//            private readonly ImplementPulseHandler outerInstance;
...
//                pos += len;
//                /* 298 */
//                this.device[devIndex].DeviceName = string.copyValueOf(nameChar);
//                /*     */
//            } /* 300 */
//            if (pos >= msgLen)
//            {
