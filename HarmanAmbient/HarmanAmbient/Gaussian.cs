...
namespace HarmanAmbient
{
    public class Gaussian
    {
        ...
        //deviation=8 gives average blurry effect
        public static Bitmap GetBlurredBitmap(double deviation, Bitmap image)
        {
            ...
            matrix = Gaussian.GaussianConvolution(matrix, deviation);
            for (int i = 0; i < image.Width; i++)
            {
                for (int j = 0; j < image.Height; j++)
                {
